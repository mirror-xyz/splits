 ...
 */
contract SplitterV2 is ISplitter {
    ...
    bytes32 private _allocationDigest;
    ...
    function validateAllocation(
        ...
        return _allocationDigest == encodeAllocation(accounts, percentages);
    }
    ...
    function executeETHSplit(
        ...
        require(validateAllocation(accounts, percentages), "Allocation is invalid");
